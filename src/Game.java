...
public class Game extends JPanel
{
	...
	{
		// load images
		spritePlayer1l = new Sprite("src/playerImages/player1l.png", 40, 40, 20, 20);
		spritePlayer1r = new Sprite("src/playerImages/player1r.png", 80, 60, 40, 30);
		spritePlayer2l = new Sprite("src/playerImages/player2l.png", 80, 60, 40, 30);
		spritePlayer2r = new Sprite("src/playerImages/player2r.png", 80, 60, 40, 30);
		spriteStage = new Sprite("src/playerImages/stage.png", 1000, 150, 500, 0);
		spriteBackground = new Sprite("src/playerImages/background.png", 1920, 1080, 960, 540);
		spriteA1 = new Sprite("src/playerImages/a1.png", 150, 150, 75, 75);
		spriteA2 = new Sprite("src/playerImages/bullet2.png", 70, 50, 35, 25);
		spriteA3 = new Sprite("src/playerImages/bulletProjectile.png", 70, 50, 35, 25);
